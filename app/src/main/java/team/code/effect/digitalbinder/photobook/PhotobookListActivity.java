...
public class PhotobookListActivity extends AppCompatActivity implements Toolbar.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        photobookListRecyclerAdapter = new PhotobookListRecyclerAdapter(this);
...
//        changePhotobookMenu(photobookListAdapter.flag);
        photobookListRecyclerAdapter.isDeleteMemuClicked = !photobookListRecyclerAdapter.isDeleteMemuClicked;
            ...
            public void onClick(DialogInterface dialog, int i) {
                switch (items[i].toString()) {
                    case AppConstans.BLUETOOTH:
                        Intent intent = new Intent(photobookListActivity, BluetoothActivity.class);
                        startActivity(intent);
                        break;
